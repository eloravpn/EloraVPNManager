...
PAYMENT_MESSAGE = """
لطفا مبلغ مورد نظر خود را به شماره کارت زیر واریز نمایید و رسید پرداخت را برای ادمین ارسال نمایید تا موجودی حساب شما شارژ گردد.
...
BUY_NEW_SERVICE_CONFIRMATION = """
 ...
 ✅ در صورت تایید این مبلغ از موجودی حساب شما کسر خواهد شد و سرویس بالا فعال خواهد شد.
"""
